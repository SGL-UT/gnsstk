...
namespace gnsstk
{
   ...
   public:
      ...
      IERSConvention getConvention() const { return iersconv; }
      ...
      EarthOrientation getEOP(double mjdutc)
      {
         ...
         /**
          ...
          @throw Exception
         */
      Position ECEFPosition(const SolarSystemEphemeris::Planet body,
                            const EphTime& tt);
      ...
      void ECEFPositionVelocity(const SolarSystemEphemeris::Planet body,
                                const EphTime& tt, Position& Pos, Position& Vel);
      ...
      void SolarPositionVelocity(const EphTime& tt, Position& Pos, Position& Vel)
      {
         try
         {
            return ECEFPositionVelocity(SolarSystemEphemeris::idSun, tt, Pos,
                                        Vel);
         }
         catch (Exception& e)
         {
      ...
      void LunarPositionVelocity(const EphTime& tt, Position& Pos, Position& Vel)
      {
         try
         {
            return ECEFPositionVelocity(SolarSystemEphemeris::idMoon, tt, Pos,
                                        Vel);
         }
         catch (Exception& e)
         {
   ...
   private:
      ...
      void testIERSvsEphemeris(const IERSConvention conv,
                               const int ephno)
      {
         if (ephno == -1)
         {
