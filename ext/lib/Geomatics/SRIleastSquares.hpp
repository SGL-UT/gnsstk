...
namespace gnsstk
{
   ...
   public:
         /// Function to fit.
      using LSFFunc = void (*)(Vector<double>& X, Vector<double>& f,
                               Matrix<double>& P);
      ...
      SRIleastSquares(const Namelist& NL);
         ...
         */
      SRIleastSquares(const Matrix<double>& R, const Vector<double>& Z,
                      const Namelist& NL);
         ...
         */
      SRIleastSquares(const SRIleastSquares& right) { *this = right; }
      ...
      SRIleastSquares& operator=(const SRIleastSquares& right);
         ...
         */
      int dataUpdate(Vector<double>& D, Vector<double>& X, Matrix<double>& Cov,
                     LSFFunc LSF);
      ...
      // ------------- member functions ---------------
         ...
         */
      Vector<double> solution() { return Xsave; }
         ...
         */
      int iterations() { return numberIterations; }
         ...
         */
      double convergence() { return rmsConvergence; }
         ...
         */
      double conditionNumber() { return conditionNum; }
