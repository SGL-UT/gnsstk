...
namespace gpstk
{
   ...
   public:
      ...
      double AU()
      {
         ...
         */
      int EphNumber() const { return EphemerisNumber; }
      ...
      double startTimeMJD() const { return (startJD - MJD_TO_JD); }

         /// Return the MJD of end time of the data (system TDB)
      double endTimeMJD() const { return (endJD - MJD_TO_JD); }
   ...
   private:
      ...
      int c_offset[13]; ///< starting index in the coefficients array for each
                        ///< planet
      int
         c_ncoeff[13]; ///< number of coefficients per component for each planet
