...
namespace gnsstk
{
   ...
   public:
      ...
      SRIFilter(const Namelist& NL);
         ...
         */
      SRIFilter(const Matrix<double>& R, const Vector<double>& Z,
                const Namelist& NL);
         ...
         */
      SRIFilter(const SRIFilter& right) { *this = right; }
      ...
      void measurementUpdate(const SparseMatrix<double>& H, Vector<double>& D,
         ...
         */
      void timeUpdate(Matrix<double>& PhiInv, Matrix<double>& Rw,
         ...
         */
      void smootherUpdate(Matrix<double>& Phi, Matrix<double>& Rw,
                          Matrix<double>& G, Vector<double>& Zw,
                          Matrix<double>& Rwx);
         ...
         */
      static void DMsmootherUpdate(Matrix<double>& P, Vector<double>& X,
         ...
         */
      static void
      DMsmootherUpdateWithControl(Matrix<double>& P, Vector<double>& X,
                                  Matrix<double>& Phinv, Matrix<double>& Rw,
                                  Matrix<double>& G, Vector<double>& Zw,
   ...
   private:
         ...
         */
      template <class T>
      static void SrifTU(Matrix<T>& R, Vector<T>& Z, Matrix<T>& Phi,
         ...
         */
      template <class T>
      static void SrifSU(Matrix<T>& R, Vector<T>& Z, Matrix<T>& Phi,
                         Matrix<T>& Rw, Matrix<T>& G, Vector<T>& Zw,
                         Matrix<T>& Rwx);
         ...
         */
      template <class T>
      static void SrifSU_DM(Matrix<T>& P, Vector<T>& X, Matrix<T>& Phinv,
                            Matrix<T>& Rw, Matrix<T>& G, Vector<T>& Zw,
                            Matrix<T>& Rwx);
