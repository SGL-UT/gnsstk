...
namespace gnsstk
{
   ...
   public:
      ...
      std::string Version() { return GDCVersion; }
   ...
   public:
      ...
      int passN, GLOn;
      int nGFslips, nWLslips, nGFslipGross, nGFslipSmall, nWLslipGross,
         nWLslipSmall;
      ...
      /**
       ...
       @throw Exception
      */
   int DiscontinuityCorrector(SatPass& SP, GDCconfiguration& config,
