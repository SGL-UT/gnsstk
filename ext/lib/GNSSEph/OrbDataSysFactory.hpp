...
#ifndef GNSSTK_ORBDATASYSFACTORY_HPP
#define GNSSTK_ORBDATASYSFACTORY_HPP
/**
...
namespace gnsstk
{
   class OrbDataSysFactory
   {
      public:
          ...
          */
      static OrbDataSys* convert(const gnsstk::PackedNavBits& pnb);

            // Factory methods for each message type
         /**
          * @throw InvalidParameter
          */
      static OrbDataSys* GPSLNAV(const gnsstk::PackedNavBits& pnb);
         /**
          * @throw InvalidParameter
          */
      static OrbDataSys* GPSCNAV(const gnsstk::PackedNavBits& pnb);
