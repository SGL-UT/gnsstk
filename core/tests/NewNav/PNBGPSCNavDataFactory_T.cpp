...
processEphTest()
{
   ...
   for (const auto& i : navOut)
   {
      if ((eph = dynamic_cast<gnsstk::GPSCNavEph*>(i.get())) != nullptr)
      {
         ...
         TUASSERTFEPS(-0.99809220403226028839, eph->M0, 1e-13);
         ...
         TUASSERTFEPS(2.6792122624362644245, eph->OMEGA0, 1e-13);
         TUASSERTFEPS(0.97640098663170327153, eph->i0, 1e-13);
         TUASSERTFEPS(0.72637343022039169149, eph->w, 1e-13);
...
processAlmOrbTest()
{
   ...
   for (const auto& i : navOut)
   {
      ...
      else if ((alm = dynamic_cast<gnsstk::GPSCNavAlm*>(i.get())) != nullptr)
      {
         ...
         TUASSERTFEPS(-1.626115508958022593, alm->M0, 1e-13);
         TUASSERTFE(0, alm->dn);
         ...
         TUASSERTFEPS(-0.4903944831271909166, alm->OMEGA0, 1e-13);
         TUASSERTFE(-0.059633503129054299396 + 0.25*gnsstk::PI, alm->i0);
         TUASSERTFEPS(-1.5729055503782394254, alm->w, 1e-13);
...
process31Test()
{
   ...
   TUASSERTFE(0, alm->Cis);
   TUASSERTFE(0, alm->Cic);
   TUASSERTFEPS(3.0925052683774527651, alm->M0, 1e-13);
   TUASSERTFE(0, alm->dn);
   TUASSERTFE(0, alm->dndot);
   ...
   TUASSERTFE(0, alm->Adot);
   TUASSERTFEPS(-0.49087385212340517437, alm->OMEGA0, 1e-13);
   TUASSERTFE((0.25+0.0056)*gnsstk::PI, alm->i0);
   TUASSERTFEPS(4.712388980384689674, alm->w, 1e-13);
   ...
   TUASSERTFEPS(3.0925052683774527651, alm->phi0, 1e-13);
   hea = nullptr;
   alm = nullptr;
      // fifth
   ++i;
   ...
   TUASSERTFE(0, alm->Cis);
   TUASSERTFE(0, alm->Cic);
   TUASSERTFEPS(0.88357293382212931387, alm->M0, 1e-13);
   TUASSERTFE(0, alm->dn);
   TUASSERTFE(0, alm->dndot);
   TUASSERTFE(7.50000000E-02, alm->ecc);
   ...
   TUASSERTFE(0, alm->Adot);
   TUASSERTFEPS(1.8162332528565992007, alm->OMEGA0, 1e-13);
   TUASSERTFE((0.25+0.0056)*gnsstk::PI, alm->i0);
   TUASSERTFEPS(4.712388980384689674, alm->w, 1e-13);
   TUASSERTFE(-8.7e-10*gnsstk::PI, alm->OMEGAdot);
   TUASSERTFE(0, alm->idot);
   ...
   TUASSERTFEPS(0.88357293382212931387, alm->phi0, 1e-13);
   hea = nullptr;
   alm = nullptr;
      // ninth
   ++i;
   ...
   TUASSERTFE(0, alm->Cis);
   TUASSERTFE(0, alm->Cic);
   TUASSERTFEPS(2.4543692606170259829, alm->M0, 1e-13);
   TUASSERTFE(0, alm->dn);
   TUASSERTFE(0, alm->dndot);
   TUASSERTFE(7.50000000E-02, alm->ecc);
   ...
   TUASSERTFEPS(2.4543692606170259829, alm->phi0, 1e-13);
   hea = nullptr;
   alm = nullptr;
      // thirteenth
   ++i;
   ...
   TUASSERTFE(0, alm->Cis);
   TUASSERTFE(0, alm->Cic);
   TUASSERTFEPS(-0.83448554860978885195, alm->M0, 1e-13);
   TUASSERTFE(0, alm->dn);
   TUASSERTFE(0, alm->dndot);
   TUASSERTFE(7.50000000E-02, alm->ecc);
   ...
   TUASSERTFE(0, alm->Adot);
   TUASSERTFEPS(-2.7979809571034093274, alm->OMEGA0, 1e-13);
   TUASSERTFE((0.25+0.0056)*gnsstk::PI, alm->i0);
   TUASSERTFEPS(4.712388980384689674, alm->w, 1e-13);
   TUASSERTFE(-8.7e-10*gnsstk::PI, alm->OMEGAdot);
   TUASSERTFE(0, alm->idot);
   ...
   TUASSERTFEPS(-0.83448554860978885195, alm->phi0, 1e-13);
   hea = nullptr;
   alm = nullptr;
   TURETURN();
}
