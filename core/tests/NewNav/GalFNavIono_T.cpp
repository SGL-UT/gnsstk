...
unsigned GalFNavIono_T ::
constructorTest()
{
   TUDEF("GalFNavIono", "GalFNavIono");
   gnsstk::GalFNavIono uut;
...
getUserTimeTest()
{
   TUDEF("GalFNavIono", "getUserTime");
   gnsstk::GalFNavIono uut;
   uut.timeStamp = gnsstk::GALWeekSecond(2100,135.0);
   gnsstk::CommonTime exp(gnsstk::GALWeekSecond(2100,145.0));
