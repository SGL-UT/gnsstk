...
processEphTest()
{
   ...
   for (const auto& i : navOut)
   {
      if ((eph = dynamic_cast<gnsstk::BDSD2NavEph*>(i.get())) != nullptr)
      {
         ...
         TUASSERTFEPS(-1.916523214107468176E+00, eph->M0, 1e-13);
         ...
         TUASSERTFEPS(-3.1259749468667630268E+00, eph->OMEGA0, 1e-13);
         TUASSERTFE( 8.6141192515002310004E-02, eph->i0);
         TUASSERTFEPS( 1.3510960489050376498E+00, eph->w, 1e-13);
