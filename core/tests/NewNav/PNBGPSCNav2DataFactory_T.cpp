...
processEphQZSSTest()
{
   ...
   for (const auto& i : navOut)
   {
      ...
      else if ((eph = dynamic_cast<gnsstk::GPSCNav2Eph*>(i.get())) != nullptr)
      {
         ...
         TUASSERTFEPS(-2.2116779253087699431E+00, eph->M0, 1e-13);
         ...
         TUASSERTFEPS(-1.2915573706629632778E+00, eph->OMEGA0, 1e-13);
         TUASSERTFEPS( 7.3069146699824139013E-01, eph->i0, 1e-13);
         TUASSERTFEPS(-1.5648458687401483047E+00, eph->w, 1e-13);
...
processAlmOrbQZSSTest()
{
   ...
   for (const auto& i : navOut)
   {
      ...
      else if ((alm = dynamic_cast<gnsstk::GPSCNav2Alm*>(i.get())) != nullptr)
      {
         ...
         TUASSERTFEPS( 1.5375281184576268245E+00, alm->M0, 1e-13);
         TUASSERTFE(0, alm->dn);
         ...
         TUASSERTFEPS( 2.6930950207317287948E+00, alm->OMEGA0, 1e-13);
         TUASSERTFE((0.25*gnsstk::PI)-7.2672339826082246739E-02, alm->i0);
         TUASSERTFEPS(-1.5638934132494111129E+00, alm->w, 1e-13);
               ...
               const gnsstk::CommonTime& expTime)
{
   ...
   TUASSERTFEPS(1.9394493464900481872, eph->M0, 1e-13);
   ...
   TUASSERTFEPS(-1.0895206889670716599E-01, eph->OMEGA0, 1e-13);
   TUASSERTFEPS(9.6039230773739858726E-01, eph->i0, 1e-13);
   TUASSERTFEPS(-1.6173077678173934935E+00, eph->w, 1e-13);
               ...
               const gnsstk::CommonTime& expTime)
{
   ...
   TUASSERTFE(0, alm->Cic);
   TUASSERTFE(0, alm->Cis);
   TUASSERTFEPS(1.0574880056486639368E-01, alm->M0, 1e-13);
   TUASSERTFE(0, alm->dn);
   TUASSERTFE(0, alm->dndot);
   ...
   TUASSERTFE(0, alm->Adot);
   TUASSERTFEPS(-2.2980949678511763956E+00, alm->OMEGA0, 1e-13);
   TUASSERTFEPS(0.95417439958456595761, alm->i0, 1e-13);
   TUASSERTFEPS(-1.7481628553941737092E+00, alm->w, 1e-13);
