...
oidFNAVGal = gpstk::ObsID(gpstk::ObservationType::NavMsg,
                          gpstk::CarrierBand::L5,
                          gpstk::TrackingCode::E5aI);
navFNAVGalPT1ct = gpstk::GALWeekSecond(1014,518400);
navFNAVGalPT2ct = gpstk::GALWeekSecond(1014,518410);
navFNAVGalPT3ct = gpstk::GALWeekSecond(1014,518420);
navFNAVGalPT4ct = gpstk::GALWeekSecond(1014,518430);
navFNAVGalPT5ct = gpstk::GALWeekSecond(1014,518440);
navFNAVGalPT6ct = gpstk::GALWeekSecond(1014,518490);
navFNAVGalSid = gpstk::SatID(1,gpstk::SatelliteSystem::Galileo);

navFNAVGalPT1 = std::make_shared<gpstk::PackedNavBits>(navFNAVGalSid,oidFNAVGal,
                                                       navFNAVGalPT1ct);
navFNAVGalPT1->setNavID(gpstk::NavType::GalFNAV);
...
navFNAVGalPT2 = std::make_shared<gpstk::PackedNavBits>(navFNAVGalSid,oidFNAVGal,
                                                       navFNAVGalPT2ct);
navFNAVGalPT2->setNavID(gpstk::NavType::GalFNAV);
...
navFNAVGalPT3 = std::make_shared<gpstk::PackedNavBits>(navFNAVGalSid,oidFNAVGal,
                                                       navFNAVGalPT3ct);
navFNAVGalPT3->setNavID(gpstk::NavType::GalFNAV);
...
navFNAVGalPT4 = std::make_shared<gpstk::PackedNavBits>(navFNAVGalSid,oidFNAVGal,
                                                       navFNAVGalPT4ct);
navFNAVGalPT4->setNavID(gpstk::NavType::GalFNAV);
...
navFNAVGalPT5 = std::make_shared<gpstk::PackedNavBits>(navFNAVGalSid,oidFNAVGal,
                                                       navFNAVGalPT5ct);
navFNAVGalPT5->setNavID(gpstk::NavType::GalFNAV);
...
navFNAVGalPT6 = std::make_shared<gpstk::PackedNavBits>(navFNAVGalSid,oidFNAVGal,
                                                       navFNAVGalPT6ct);
navFNAVGalPT6->setNavID(gpstk::NavType::GalFNAV);
