...
constructorTest()
{
   ...
   TUASSERTE(gnsstk::CommonTime, gnsstk::CommonTime(), uut.xmit5);
   ...
   TUASSERTE(gnsstk::GalDataValid,gnsstk::GalDataValid::Unknown,uut.dvsE5b);
   TUASSERTE(gnsstk::GalDataValid,gnsstk::GalDataValid::Unknown,uut.dvsE1B);
...
getUserTimeTest()
{
   ...
   uut.xmit5 = gnsstk::GALWeekSecond(2100,11.0);
   gnsstk::CommonTime exp(gnsstk::GALWeekSecond(2100,202.0));
