...
processEphTest()
{
   ...
   for (const auto& i : navOut)
   {
      if ((eph = dynamic_cast<gnsstk::BDSD1NavEph*>(i.get())) != nullptr)
      {
         ...
         TUASSERTFEPS(-1.9160860634641034839E+00, eph->OMEGA0, 1e-13);
         TUASSERTFEPS(9.450732988963341796E-01, eph->i0, 1e-13);
         TUASSERTFEPS(-2.1772769963262814663E+00, eph->w, 1e-13);
