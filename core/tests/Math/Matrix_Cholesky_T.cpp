...
void choleskyTest(size_t r, size_t c,
                  ...
                  gnsstk::TestUtil& testFramework, const std::string& str)
{
   testFramework.changeSourceMethod(str);
   double eps=5*DBL_EPSILON;
   gnsstk::Matrix<double> A(r,c);
   A = xA;
   gnsstk::Cholesky<double> C;
   C(A);
...
int main()
{
   ...
   gnsstk::TestUtil testFramework2("Matrix CholeskyCrout", "--", __FILE__, __LINE__);
