...
namespace gnsstk
{
   ...
   bool GPSLNavTimeOffset::isSameData(const NavDataPtr& right, bool ignore_timestamp) const
   {
      const std::shared_ptr<GPSLNavTimeOffset> GPSLTO = std::dynamic_pointer_cast<GPSLNavTimeOffset>(right);
