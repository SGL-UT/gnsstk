...
namespace gpstk
{
   ...
   dumpSVStatus(std::ostream& s) const
   {
      ...
      s << "           PAGE OVERHEAD" << endl
        ...
        << printTime(xmitTime,"Word 1 TOW : %6.0g  %3a-%1w:%02H:%02M:%02S")
        << setw(13) << iodnav1 << endl
        << printTime(xmit2,"Word 2 TOW : %6.0g  %3a-%1w:%02H:%02M:%02S")
        << setw(13) << iodnav2 << endl
        << printTime(xmit3,"Word 3 TOW : %6.0g  %3a-%1w:%02H:%02M:%02S")
        ...
        << " (" << gpstk::StringUtils::asString(dvsE5b) << ")" << endl
        << "E5b_HS              : " << setw(9) << static_cast<int>(hsE5b)
        << " (" << gpstk::StringUtils::asString(hsE5b) << ")" << endl
        << "E1B_DVS             : " << setw(9) << static_cast<int>(dvsE1B)
        << " (" << gpstk::StringUtils::asString(dvsE1B) << ")" << endl
        << "E1B_HS              : " << setw(9) << static_cast<int>(hsE1B)
        << " (" << gpstk::StringUtils::asString(hsE1B) << ")" << endl
