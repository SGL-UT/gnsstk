...
namespace gpstk
{
   ...
   private:
      ...
      std::vector<std::string>
         obstypes;                     ///< obstypes to monitor (L1 L2 C1 C2 P1 P2)
      ...
      std::map<std::string, int>
         typesMap;                     ///< [string "P1 C2 !L1 !L2"] = number of adj
    ...
    public:
      ...
      std::vector<std::string> getEditCommands() { return editCmds; }
      ...
      int getNMS() { return times.size(); }

      /// get the number of invalid adjusts found
      int getNbadMS() { return badMsgs.size(); }

      /** get map<CommonTime,int> of valid adjusts; should parallel
          getFindMessage() */
      std::map<gpstk::CommonTime, int> getAdjusts();
