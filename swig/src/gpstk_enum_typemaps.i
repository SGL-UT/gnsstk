...
ENUM_MAPPER(gpstk::NavMessageType, NavMessageType)
ENUM_MAPPER(gpstk::SVHealth, SVHealth)
ENUM_MAPPER(gpstk::NavSearchOrder, NavSearchOrder)
ENUM_MAPPER(gpstk::NavValidityType, NavValidityType)
ENUM_MAPPER(gpstk::DumpDetail, DumpDetail)
